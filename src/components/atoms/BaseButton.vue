...
const styles = {
  common:
    'rounded-lg disabled:cursor-not-allowed focus:ring-offset-0 focus:ring-2 active:ring-2 box-border flex justify-center items-center disabled:bg-gray-75 disabled:text-neutral-50',
  colors: {
    primary: {
